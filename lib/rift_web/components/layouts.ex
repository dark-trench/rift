defmodule RiftWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <header class="border-b border-slate-200 bg-white">
      <nav class="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        <a href="/" class="flex items-center gap-3">
          ...
          <span class="text-sm font-semibold text-slate-950">Rift</span>
        </a>
    ...
    <main class="min-h-[calc(100vh-57px)] bg-slate-50 px-4 py-10 sm:px-6 lg:px-8">
